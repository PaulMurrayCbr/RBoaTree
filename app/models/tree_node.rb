class TreeNode < ActiveRecord::Base
  ...
  has_one :copy_of, class_name: :TreeNode, foreign_key: :prev_node_id

  has_many :replacement_of, class_name: :TreeNode, foreign_key: :prev_node_id
  has_many :copies, class_name: :TreeNode, foreign_key: :next_node_id
