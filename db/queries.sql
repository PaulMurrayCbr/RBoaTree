...
$$
-- this function returns trees where this node is placed under a CURRENT node
begin
...
create or replace function get_workspace_placements(start_node_id integer)
returns table(tree_id integer) as
$$
-- this function returns trees where this node is placed. It's potentially a little
-- expensive, because it navigates through all nodes, not just current ones.
begin
	-- not sure how to do this as a prepared cursor with a parameter
	-- and I don't really care at this stage
	return query execute '
